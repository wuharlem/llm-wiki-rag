...
RULES_02A: list[tuple[str, str, list[str]]] = [
    ...
    ("02b_Constitutional-AI", "CAI", [
        "constitutional ai", "constitutional_ai", "rlaif",
    ]),
    ("01c_Alignment-Faking-Scheming", "scheming/faking", [
        "sleeper agent", "alignment faking", "alignment-faking",
        "detecting and reducing scheming", "sandbagging",
    ...
    ("01d_Agentic-Misalignment-and-Control", "agentic/control", [
    ...
    ("02c_Scalable-Oversight", "scalable oversight", [
        "scalable oversight", "ai safety via debate",
        "doubly-efficient debate",
        "prover-verifier game", "prover_verifier", "p_rover", "checkable answers with prover",
    ...
    ("02d_Weak-to-Strong-and-ELK", "W2S/ELK", [
        "weak-to-strong", "weak to strong", "w2sg", "easy-to-hard", "easy to hard",
        "the unreasonable effectiveness of easy training data",
        "generative_ai_research_weak-to-strong",
    ]),
    ("02e_Pretraining-Filtering-and-Unlearning", "pretraining/unlearning", [
        "deep ignorance", "filtering pretraining", "pretraining filtering",
        "harnessing diversity for important data", "qurating", "mates_model-aware data selection",
        "improving pretraining data using perplexity",
        "mitigating harm in language models with conditional-likelihood filtration",
        "modifying memories", "editable neural networks",
        "pretraining language models with human preferences",
        "reclaiming the digital commons",
    ]),
    ("02f_Interpretability", "interp", [
    ...
    ("05a_Educational", "course/lecture", [
        "cs188", "lec25",
    ]),
    ("05b_Sources-Background", "lab announcement / report", [
    ...
    ("LEAVE", "core RLHF", [
        ...
        "koh17a", "macglashan17a", "journal_of_machine_learning_research",
...
RULES_03E: list[tuple[str, str, list[str]]] = [
    ...
    ("01c_Alignment-Faking-Scheming", "scheming/faking", [
        ...
        "ai sandbagging", "fake alignment", "are llms really aligned",
    ...
    # UNLEARNING → 02e
    ("02e_Pretraining-Filtering-and-Unlearning", "unlearning", [
    ...
    ("03a_Methodology", "methodology", [
        "evals — marius hobbhahn", "starter resources", "starter guide",
        "science of evals", "adding error bars",
        "betterbench", "sociotechnical eval",
        "apollo reading list", "reading list",
        ...
        "llm-as-a-judge", "judging llm-as-a-judge",
    ]),
    # CAPABILITY BENCHMARKS
    ("03b_Capability-Benchmarks", "capability bench", [
        "mmlu", "math benchmark", "big-bench", "big bench", "hellaswag", "piqa",
        "frontiermath", "frontier math", "ethics_b", "ethics benchmark",
        "cosmos qa", "cosmosqa",
        "openbook", "open book",
        "boolq", "arc_b", "arc-easy", "arc-c",
        "agieval", "winogrande",
        "gpqa a graduate-level google-proof",
        "humaneval", "human-eval", "evaluating large language models trained on code",
        "language models are few-shot learners",
        "ling oly", "olympiad-level linguistic",
        "finetuned language models are zero-shot learners",
        "gemini a family of highly capable multimodal models",
    ]),
    # CYBER / BIO BENCHMARKS
    ("03c_Cyber-Bio-Benchmarks", "cyber/bio bench", [
        "wmdp", "lab-bench", "labbench",
        "cybench", "cyberseceval", "cve-bench", "3cb", "catastrophic cyber",
        "virology capabilities test",
        "biorisk evaluation", "biorisk evaluations",
        "spear phishing", "spear-phishing", "fully automated spear",
        "evaluating frontier models for dangerous capabilities",
        "intercode standardizing and benchmarking interactive coding",
        "stro ng rej ect for empty jailbreaks", "strongreject",
    ]),
    # AGENT BENCHMARKS
    ("03d_Agent-Benchmarks-and-Frameworks", "agent bench", [
        "agentbench", "agentdojo", "webarena", "swe-bench", "swebench",
        "aviary", "mle-bench", "mle bench", "mle_bench",
        "vending-bench", "vending bench",
        "agent benchmark",
    ]),
    # ORG PAGES / ANNOUNCEMENTS → 05b
    ("05b_Sources-Background", "org/announcement", [
        "apart research", "apollo research",
        "buck s shortform", "buck's shortform",
        "cognitive dissonance",  # blog post
    ]),
    # GENERAL ALIGNMENT / RLHF (not eval-specific) → 02a
    ("02a_RLHF-and-Limitations", "rlhf-related", [
    ...
    ("01a_Existential-Risk", "x-risk", [
        "is power-seeking ai an existential risk",
    ]),
    # SAFETY FRAMEWORK → 04a
    ("04a_RSPs-and-Frontier-Frameworks", "RSP", [
        "xai-risk-management-framework", "xai risk management",
    ]),
]
