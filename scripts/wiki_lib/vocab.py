...
def _risks() -> dict[str, list[str]]:
    ...
    # may rename or drop risk_category (e.g. the LLM Philosophy wiki's
    # philosophical_area) — importing this module must never crash the
    # build path. Axis-generic code should read
