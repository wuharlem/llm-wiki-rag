...
TITLE_FIXES = [
    ...
    ("03_Evaluations/03e_Other-Evaluations/Buck_S_Shortform_f162cf38.md",
     "Buck S Shortform",
     "Buck's Shortform"),
...
STUB_AUTHORS_TO_NULL = [
    ...
    ("02_Mitigations-and-Methods/02e_Pretraining-Filtering-and-Unlearning/Unlearning_Bias_in_Language_Models_by_Partitioning_Gradients_148b0a55.md", "Adjust author names; Order"),
    ("03_Evaluations/03b_Capability-Benchmarks/Cosmos_QA_Machine_Reading_Comprehension_with_Contextual_Commonsense_Reasoning_a5443f4c.md", "Adjust author names; Order"),
    ("05_Resources/05b_Sources-Background/Going_on_a_vacation_takes_longer_than_Going_for_a_walk_A_Study_of_Temporal_Commonsense_Understanding_ab7380ce.md", "Adjust author names; Order"),
]
