...
MOVES = [
    ...
    ("KullbackLeibler_divergence_-_Wikipedia",
     "05_Resources/05b_Sources-Background",
     "math background"),
    ("Statistical_hypothesis_test_-_Wikipedia",
     "05_Resources/05b_Sources-Background",
     "stats background"),
    ("Tit_for_tat_-_Wikipedia",
     "05_Resources/05b_Sources-Background",
    ...
    ("Externality_-_Wikipedia",
     "05_Resources/05b_Sources-Background",
     "economics Wikipedia"),
    ("Sortition_-_Wikipedia",
     "05_Resources/05b_Sources-Background",
     "political philosophy Wikipedia"),
    ("WikipediaManual_of_Style",
     "05_Resources/05b_Sources-Background",
     "Wikipedia meta-page, not on-topic anywhere"),
    ...
    ("3cb-the-catastrophic-cyber-capabilities-benchmark", # url match approx
     None, None, None),  # placeholder; will look up by partial filename below
    ("Catastrophic_Cyber_Capabilities_Benchmark_3CB",
     "03_Evaluations/03c_Cyber-Bio-Benchmarks",
     "explicit cyber benchmark"),
    ("LLM_CTF_SaTML",
     "03_Evaluations/03c_Cyber-Bio-Benchmarks",
     "LLM capture-the-flag cyber competition"),

    # Bio benchmarks
    ("Virology_Capabilities_Test",
     "03_Evaluations/03c_Cyber-Bio-Benchmarks",
     "explicit bio capability test (VCT)"),

    # Agent benchmarks
    ("Vending-Bench",
     "03_Evaluations/03d_Agent-Benchmarks-and-Frameworks",
     "agent long-horizon coherence benchmark"),
    ("Language_Model_Pilot_Report",
     "03_Evaluations/03d_Agent-Benchmarks-and-Frameworks",
     "METR agent eval report"),
    ...
    # Methodology
    ("We_Need_A_Science_of_Evals",
     "03_Evaluations/03a_Methodology",
     "explicit methodology argument"),
