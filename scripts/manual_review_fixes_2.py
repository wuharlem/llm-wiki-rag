...
MOVES = [
    ...
    (
        "Reliable_Shared_Web_Hosting_Services",
        "05_Resources/05b_Sources-Background",
        "web hosting marketing — not a research artifact",
    ),
    ...
    (
        "All_Possible_Views_About_Humanitys_Future_Are_Wild",
        "01_Risks-and-Failure-Modes/01a_Existential-Risk",
        "Karnofsky x-risk essay",
    ),
    ("CERN_for_AI_An_overview", "01_Risks-and-Failure-Modes/01a_Existential-Risk", "Brundage CERN-for-AI proposal"),
    (
        "Embedded_Agency_Full_Text_Version",
        "01_Risks-and-Failure-Modes/01a_Existential-Risk",
        "MIRI embedded agency theory",
    ),
    ("Sunset_At_Noon", "01_Risks-and-Failure-Modes/01a_Existential-Risk", "LessWrong essay on AI urgency"),
    (
        "Ugh_Fields",
        "01_Risks-and-Failure-Modes/01a_Existential-Risk",
        "rationality, weak relevance — keep with x-risk LW cluster",
    ),
    (
        "Without_Fundamental_Advances_Misalignment_And_Catastrophe",
        "01_Risks-and-Failure-Modes/01a_Existential-Risk",
        "x-risk argument",
    ),
    (
        "Without_Specific_Countermeasures_The_Easiest_Path_To",
        "01_Risks-and-Failure-Modes/01a_Existential-Risk",
        "Cotra x-risk default-path",
    ),
    ...
    (
        "A_small_number_of_samples_can_poison",
        "02_Mitigations-and-Methods/02e_Pretraining-Filtering-and-Unlearning",
        "Anthropic poisoning paper",
    ),
    (
        "Deep_Ignorance_Filtering_Pretraining",
        "02_Mitigations-and-Methods/02e_Pretraining-Filtering-and-Unlearning",
        "EleutherAI Deep Ignorance",
    ),
    (
        "Enhancing_Model_Safety_through_Pretraining_Data_Filtering",
        "02_Mitigations-and-Methods/02e_Pretraining-Filtering-and-Unlearning",
        "Anthropic CBRN data filtering",
    ),
    # === Scheming → 01c ===
    (
        "Detecting_and_reducing_scheming",
        "01_Risks-and-Failure-Modes/01c_Alignment-Faking-Scheming",
        "OpenAI scheming detection",
    ),
    (
        "Another_Outer_Alignment_Failure_Story",
        "01_Risks-and-Failure-Modes/01c_Alignment-Faking-Scheming",
        "Christiano alignment failure",
    ),
    # === Constitutional AI papers → 02b ===
    (
        "Constitutional_AI_Harmlessness_from_AI_Feedback_5eacf5e7",
        "02_Mitigations-and-Methods/02b_Constitutional-AI",
        "Bai et al. CAI paper (md version)",
    ),  # if exists
    # === W2SG → 02d ===
    (
        "Weak-to-Strong_Generalization_Eliciting_Strong_Capabilities",
        "02_Mitigations-and-Methods/02d_Weak-to-Strong-and-ELK",
        "Burns et al. W2SG paper",
    ),
    # === Governance / policy → 04 ===
    ("Article_56_Codes_of_Practice", "04_Governance-and-Policy/04c_Other-Governance", "EU AI Act"),
    (
        "FMF_Announces_First-Of-Its-Kind",
        "04_Governance-and-Policy/04a_RSPs-and-Frontier-Frameworks",
        "Frontier Model Forum agreement",
    ),
    (
        "How_AI_Labs_Can_Safeguard_Model_Weights",
        "04_Governance-and-Policy/04c_Other-Governance",
        "RAND report on weight security",
    ),
    ("Location_Verification_for_AI_Chips", "04_Governance-and-Policy/04c_Other-Governance", "IAPS compute governance"),
    (
        "Model_Safety_Bug_Bounty_Program",
        "04_Governance-and-Policy/04a_RSPs-and-Frontier-Frameworks",
    ...
    (
        "U.S._Pushes_for_Less_AI_Regulation_at_Paris",
        "04_Governance-and-Policy/04c_Other-Governance",
        "Paris summit news",
    ),
    ("What_Is_DeepSeek", "04_Governance-and-Policy/04c_Other-Governance", "China AI policy news"),
    (
        "What_normal_Americans_not_AI_companies_want_for_AI",
        "04_Governance-and-Policy/04c_Other-Governance",
        "polling-driven policy commentary",
    ),
    (
        "The_Computational_Democracy_Project",
        "04_Governance-and-Policy/04c_Other-Governance",
        "Polis platform / democratic AI",
    ),
    ...
    (
        "John_Schulman_OpenAI_Cofounder",
        "01_Risks-and-Failure-Modes/01b_AGI-Capability-and-Forecasting",
        "Dwarkesh interview on 2027 AGI plan",
    ),
    # === Methodology / agenda → 03a ===
    (
        "Recommendations_for_Technical_AI_Safety_Research_Directions",
        "03_Evaluations/03a_Methodology",
        "Anthropic research agenda — methodology",
    ),
    (
        "The_Case_For_More_Ambitious_Language_Model_Evals",
        "03_Evaluations/03a_Methodology",
        "LessWrong methodology argument",
    ),
    # === Educational explainers → 05a_Educational ===
    (
        "Reinforcement_Learning_from_Human_Feedback_RLHF_A_Simple_Explainer",
        "05_Resources/05a_Educational",
        "BlueDot RLHF explainer",
    ),
    ("What_is_Recursive_Reward_Modelling", "05_Resources/05a_Educational", "BlueDot RRM explainer"),
    (
        "Problems_with_Reinforcement_Learning_from_Human_Feedback_RLHF_for_AI_safety",
        "05_Resources/05a_Educational",
        "BlueDot RLHF problems explainer",
    ),
